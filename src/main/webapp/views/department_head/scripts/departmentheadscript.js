//USING AJAX TO PULL INFO FROM FRONT CONTROLLER

      function getAllSuperForms(){
    		let url = "/P1Servlet/creativeconcepts/reimburesmentforms/dh_pending";
	      ...
	      function getAllEmpForms(){
	  		let url = "/P1Servlet/creativeconcepts/pending_under_dh";
	  		let xhr = new XMLHttpRequest();
